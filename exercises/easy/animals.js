...
// (master's name)! Woof, woof!. (Make sure you replace (master's name)
...
let spot = new Dog('Spot', 10, 'very happy', 'Jay');

console.log(spot.introduce());
console.log(spot.greetMaster());